...
public class Main {
    ...
    public String main(String country, String configfile, String runtimeDataDir, String licensePlate) throws Exception {
    System.out.print("Came to Java Main of ALPR");
      ...
      /*  else
        ...
        System.out.println("OpenALPR Path: " + path.getFileName() +"---"+path.getRoot());
