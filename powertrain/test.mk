...
ENVS=config-api.url=http://composite-it.cars.com/config-api/1.0/rest/config
LABELS=BIGIP_POOL=cars_docker_license_plate_recognition_it,ENV=it
INSTANCES=1
