...
## TODO Check with DevOps if this env variable can be used. DT_AGENT_PATH=/apps/Dynatrace/agent/lib64/libdtagent.so=name=license_plate_recognition!!server=cj8dyl001.cars.com:10001

JAVA_OPTS=-Xms256m,-Xmx512m,-XX:+PrintFlagsFinal
ENVS=config-api.url=http://composite-ft.cars.com/config-api/1.0/rest/config
LABELS=BIGIP_POOL=cars_docker_license_plate_recognition_ft,ENV=ft
INSTANCES=1
