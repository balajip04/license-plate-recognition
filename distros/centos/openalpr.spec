...
%setup -n license-plate-recognition/src
...
%defattr(-,root,root,-)
  ...
  /etc/license-plate-recognition/openalpr.conf
  /usr/bin/alpr
  /usr/share/man/man1/alpr.1.gz


   %exclude /usr/lib/python2.7/site-packages/license-plate-recognition/*.pyc
   %exclude /usr/lib/python2.7/site-packages/license-plate-recognition/*.pyo
...
%files daemon
%defattr(-,root,root,-)
  /etc/license-plate-recognition/alprd.conf
  /usr/bin/alprd
...
%defattr(-,root,root,-)
  /usr/share/license-plate-recognition/runtime_data/
...
%defattr(-,root,root,-)
  /usr/lib/python2.7/site-packages/license-plate-recognition/*.py
