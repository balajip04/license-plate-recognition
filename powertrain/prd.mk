...
## TODO Check with DevOps if this env variable can be used. DT_AGENT_PATH=/apps/Dynatrace/agent/lib64/libdtagent.so=name=license_plate_recognition!!server=cs1dyl001.cars.com:9991

JAVA_OPTS=-Xms256m,-Xmx512m,-XX:+PrintFlagsFinal
ENVS=config-api.url=http://composite.cars.com/config-api/1.0/rest/config
LABELS=BIGIP_POOL=cars_docker_license_plate_recognition_prd,ENV=prd
INSTANCES=1
