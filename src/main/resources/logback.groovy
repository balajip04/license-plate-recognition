...
def LOG_FILE = 'license-plate-recognition.log'

//hostName will be container id if running inside a docker container
def hostName = System.getenv("HOSTNAME")

if (hostName != null) {
	LOG_FILE = 'license-plate-recognition.' + hostName + '.log'
}

def logPath = '/apps/docker/logs/splunkme/license-plate-recognition'
...
logger("com.cars.alpr", ERROR, ["CONSOLE"], false)
